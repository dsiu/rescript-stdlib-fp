...
Jest.describe("fromList", () => Jest.test("transforms a list into an array of the same elements", () => Jest.Expect.toEqual(Jest.Expect.expect(Core__List.toArray({
  hd: 1,
  tl: {
    hd: 2,
    tl: {
...
Jest.describe("toList", () => Jest.test("transform an array into a list of the same elements", () => Jest.Expect.toEqual(Jest.Expect.expect(Core__List.fromArray([
  1,
  2,
  3
])), {

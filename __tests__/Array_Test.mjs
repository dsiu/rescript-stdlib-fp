...
Jest.describe("minimum", (function () {
        ...
        Jest.test("returns none is empty", (function () {
                return Jest.Expect.toEqual(Jest.Expect.expect(Stdlib__Array.minimum([], Caml.int_compare)), undefined);
              }));
      }));
...
Jest.describe("maximum", (function () {
        ...
        Jest.test("returns none is empty", (function () {
                return Jest.Expect.toEqual(Jest.Expect.expect(Stdlib__Array.maximum([], Caml.int_compare)), undefined);
              }));
      }));
...
Jest.describe("extent", (function () {
        ...
        Jest.test("returns range on single", (function () {
                return Jest.Expect.toEqual(Jest.Expect.expect(Stdlib__Array.extent([1], Caml.int_compare)), [
                            1,
                            1
                          ]);
              }));
        Jest.test("returns none is empty", (function () {
                return Jest.Expect.toEqual(Jest.Expect.expect(Stdlib__Array.extent([], Caml.int_compare)), undefined);
              }));
      }));

...
Jest.test("minimumValue", () => Jest.Expect.toEqual(Jest.Expect.expect(Stdlib_Int.Constants.minValue - 1 | 0), Stdlib_Int.Constants.maxValue));

Jest.test("maximumValue", () => Jest.Expect.toEqual(Jest.Expect.expect(Stdlib_Int.Constants.maxValue + 1 | 0), Stdlib_Int.Constants.minValue));

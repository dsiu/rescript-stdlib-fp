...
Jest.test("compose", (function () {
        return Jest.Expect.toEqual(Jest.Expect.expect((function (extra) {
                            return Stdlib__Function.compose(increment, $$double, extra);
                          })(1)), 4);
      }));

Jest.test("composeRight", (function () {
        return Jest.Expect.toEqual(Jest.Expect.expect((function (extra) {
                            return Stdlib__Function.composeRight(increment, $$double, extra);
                          })(1)), 3);
      }));

Jest.test("tap", (function () {

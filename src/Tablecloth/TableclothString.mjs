...
function initialize(length, f) {
  return $$Array.init(length, (function (index) {
                  return TableclothChar.toString(f(index));
                })).join("");
}
...
function forEach(t, f) {
  Js_array.forEach((function (a) {
          f(a);
        }), toArray(t));
}

function fold(t, initial, f) {
  return Core__Array.reduce(toArray(t), initial, (function (a, ch) {
                return f(a, ch);
              }));
}

var compare$1 = Caml.string_compare;

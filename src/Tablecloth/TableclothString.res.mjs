...
import * as TableclothChar from "./TableclothChar.res.mjs";
import * as Primitive_object from "rescript/lib/es6/Primitive_object.js";
import * as Primitive_string from "rescript/lib/es6/Primitive_string.js";
import * as TableclothComparator from "./TableclothComparator.res.mjs";
...
function initialize(length, f) {
  return Stdlib_Array.fromInitializer(length, index => TableclothChar.toString(f(index))).join("");
}
...
function fromList(t) {
  return Stdlib_List.toArray(t).map(character => String.fromCharCode(TableclothChar.toCode(character))).join("");
}
...
function fold(t, initial, f) {
  return Stdlib_Array.reduce(toArray(t), initial, (a, ch) => f(a, ch));
}

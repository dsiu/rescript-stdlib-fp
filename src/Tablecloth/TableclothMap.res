...
let fromList = (comparator, l) => fromArray(comparator, List.toArray(l))
...
let keys = m => List.fromArray(Belt.Map.keysToArray(m))

let values = m => List.fromArray(Belt.Map.valuesToArray(m))

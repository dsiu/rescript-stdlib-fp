...
function Make(Serializable) {
  ...
  let keys = t => t.keys().map(x => Serializable.fromStringUnsafe(x));
  let values = prim => prim.values();
  let entries = t => t.entries().map(param => [
...
function keys$5(t) {
  return t.keys().map(x => Serializable.fromStringUnsafe(x));
}
...
function keys$6(t) {
  return t.keys().map(x => Serializable$1.fromStringUnsafe(x));
}
...
function keys$7(t) {
  return t.keys().map(x => Serializable$2.fromStringUnsafe(x));
}
...
function keys$8(t) {
  return t.keys().map(x => Serializable$3.fromStringUnsafe(x));
}
...
function keys$9(t) {
  return t.keys().map(x => Serializable$4.fromStringUnsafe(x));
}
...
function keys$10(t) {
  return t.keys().map(x => Serializable$5.fromStringUnsafe(x));
}
...
function keys$11(t) {
  return t.keys().map(x => Serializable$6.fromStringUnsafe(x));
}
